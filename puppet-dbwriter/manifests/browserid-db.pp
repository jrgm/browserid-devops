...
file {"/service/browserid-browserid/run":
  ...
  source => "/vagrant/puppet-dbwriter/files/daemontools/browserid-browserid/run",
  owner => "root",
  mode => "0755"
}
...
file {"/service/browserid-example/run":
  ...
  source => "/vagrant/puppet-dbwriter/files/daemontools/browserid-example/run",
  owner => "root",
  mode => "0755"
}
...
file {"/service/browserid-keysigner/run":
  ...
  source => "/vagrant/puppet-dbwriter/files/daemontools/browserid-keysigner/run",
  owner => "root",
  mode => "0755"
}
...
file {"/service/browserid-router/run":
  ...
  source => "/vagrant/puppet-dbwriter/files/daemontools/browserid-router/run",
  owner => "root",
  mode => "0755"
}
...
file {"/service/browserid-verifier/run":
  ...
  source => "/vagrant/puppet-dbwriter/files/daemontools/browserid-verifier/run",
  owner => "root",
  mode => "0755"
}
...
file {"/service/browserid-example-primary/run":
  ...
  source => "/vagrant/puppet-dbwriter/files/daemontools/browserid-example-primary/run",
  owner => "root",
  mode => "0755"
}
...
file {"/service/browserid-proxy/run":
  ...
  source => "/vagrant/puppet-dbwriter/files/daemontools/browserid-proxy/run",
  owner => "root",
  mode => "0755"
}
...
file {"/service/browserid-static/run":
  ...
  source => "/vagrant/puppet-dbwriter/files/daemontools/browserid-static/run",
  owner => "root",
  mode => "0755"
}
